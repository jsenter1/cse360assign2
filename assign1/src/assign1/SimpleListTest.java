...
public class SimpleListTest {
	...
	public void countTest() {
		...
		assertEquals(1, simpleList.count());
	}
	...
	public void toStringTest() {
		...
		simpleList.add(100);
		simpleList.add(110);
		assertEquals("110 100 90 80 70 60 50 40 30 20", simpleList.toString());
		simpleList.remove(80);
		assertEquals("110 100 90 70 60 50 40 30 20", simpleList.toString());
		simpleList.remove(110);
		assertEquals("100 90 70 60 50 40 30 20", simpleList.toString());
		simpleList.remove(20);
		assertEquals("100 90 70 60 50 40 30", simpleList.toString());
	}
